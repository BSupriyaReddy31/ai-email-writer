...
@import url('https://fonts.googleapis.com/css2?family=Lora:wght@400;500;600;700&display=swap');
    html, body, [class*="css"], [class*="st-"], p, h1, h2, h3, h4, h5, h6, label, input, textarea, div, span, button, a {
...
with tab2:
    ...
    if not st.session_state.email_history:
        ...
        for i, record in enumerate(st.session_state.email_history):
            with st.expander(f" ✉️ To: {record['recipient's name']} | 🎭 Tone: {record['tone']}"):
